...
urlpatterns = [
    ...
    path('embedded/search/', views.SearchResultsView.as_view(embedded=True), name='embedded-search-results'),
    ...
    path('embedded/photo/<str:photo>/', views.PhotoView.as_view(embedded=True), name='embedded-photoview'),
    path('embedded/photo/<int:page>/<str:photo>/', views.PhotoView.as_view(embedded=True), name="embedded-photoview"),
    path('embedded/photo/<int:page>/<str:photo>.json', views.JSONPhotoView.as_view(embedded=True), name="embedded-photoview-json"),
    ...
    path('embedded/grid/', views.GridView.as_view(embedded=True), name='embedded-gridview'),
    path('grid/<int:page>/', views.GridView.as_view(), name='gridview'),
    path('embedded/grid/<int:page>/', views.GridView.as_view(embedded=True), name='embedded-gridview'),
